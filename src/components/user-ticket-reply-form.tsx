...
import { userReplyToTicketAction } from "@/app/actions";
...
export function UserTicketReplyForm({ ticketId }: { ticketId: string }) {
  const action = userReplyToTicketAction.bind(null, ticketId);
