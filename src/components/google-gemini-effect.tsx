...
const transition = {
  duration: 1, // Adjusted for a slightly slower draw
  ease: "linear",
};
...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("h-[400vh] w-full bg-black dark:border dark:border-white/[0.1] rounded-md relative pt-40 overflow-clip", className)}>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-full px-4">
        <p className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400">
          {title || `Gc Fiber Net`}
        </p>
        <p className="text-sm md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-2xl mx-auto">
          {description ||
            `Experience smooth streaming, lag-free gaming, and dependable connectivity.`}
        </p>
        <div className="flex items-center justify-center gap-4 mt-8">
            <Button asChild size="lg">
                <Link href="/auth/signup">🚀 Check Availability</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="bg-transparent text-white/80 border-white/20 hover:bg-white/5 hover:text-white">
      ...
      >
        ...
        <defs>
            ...
            <motion.linearGradient
                ...
                y2="0"
            >
                <stop stopColor="#E2446D" />
                <stop offset="1" stopColor="#E2446D" stopOpacity="0" />
            </motion.linearGradient>
            <motion.linearGradient
                id="gradient3"
                gradientUnits="userSpaceOnUse"
                ...
                y2="0"
            >
                <stop stopColor="#1634f1" />
                <stop offset="1" stopColor="#1634f1" stopOpacity="0" />
            </motion.linearGradient>
            <motion.linearGradient
                id="gradient4"
                gradientUnits="userSpaceOnUse"
                ...
                y2="0"
            >
                <stop stopColor="#4FABFF" />
                <stop offset="1" stopColor="#4FABFF" stopOpacity="0" />
            </motion.linearGradient>
            <motion.linearGradient
                id="gradient5"
                gradientUnits="userSpaceOnUse"
                ...
                y2="0"
            >
                <stop stopColor="#076EFF" />
                <stop offset="1" stopColor="#076EFF" stopOpacity="0" />
            </motion.linearGradient>
        </defs>
      </svg>
    </div>
