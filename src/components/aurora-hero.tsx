...
export const AuroraHero: React.FC = () => {
  ...
  const hero = { 
    ...
    subtitle: 'Experience smooth streaming, lag-free gaming, and dependable connectivity — powered by your trusted local ISP right here in Aali Village.', 
  };
        ...
        <main id="about" className="w-full min-h-screen flex flex-col items-center justify-center px-6 py-20 text-white">
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link href={ctaButtons.primary.href} className="primary-button px-6 py-3 rounded-lg font-medium text-sm min-w-[180px] text-center">🚀 {ctaButtons.primary.label}</Link>
                    <Link href={ctaButtons.secondary.href} className="glass-button min-w-[180px] text-sm font-medium rounded-lg px-6 py-3 text-center">📞 {ctaButtons.secondary.label}</Link>
                </div>
            </div>
        </main>
      </div>
